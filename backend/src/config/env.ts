...
export const env = {
  ...
  chessEnabled: readEnv("CHESS_ENABLED", "false") === "true",
  chessComApiBaseUrl: readEnv("CHESS_COM_API_BASE_URL", "https://api.chess.com/pub"),
  chessAnalysisEnginePath: readEnv("CHESS_ANALYSIS_ENGINE_PATH", "stockfish"),
  chessAnalysisDepth: Number(readEnv("CHESS_ANALYSIS_DEPTH", "14")),
  chessAnalysisMoveTimeMs: Number(readEnv("CHESS_ANALYSIS_MOVE_TIME_MS", "300")),
  chessLessonMinOccurrences: Number(readEnv("CHESS_LESSON_MIN_OCCURRENCES", "3")),
